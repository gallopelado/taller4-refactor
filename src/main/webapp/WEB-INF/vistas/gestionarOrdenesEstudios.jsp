...
<html lang="es">
    <head>
        ...
        <title>Órdenes de Estudios - DiazPet</title>
    ...
    <body>
        ...
        <div class="main-content">
            <div class="top-bar">
                <div>
                    <h2><i class="fas fa-x-ray"></i> Gestión de Órdenes de Estudios</h2>
                    <p class="date mb-0">
            ...
            <div class="content-area">
                    ...
                    <div class="card-custom-body">
                        ...
                        <div id="contenedorResultados">
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle"></i> Busca una mascota para gestionar sus órdenes de estudios
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-custom" id="contenedorOrdenes" style="display: none;">
                    <div class="card-custom-header">
                        <h5><i class="fas fa-file-medical"></i> Órdenes de Estudios de la Mascota</h5>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fas fa-plus"></i> Registrar Orden de Estudio</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Tipo de Estudio: <span class="text-danger">*</span></label>
                            <select id="selectTipoEstudio" class="form-select" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="txtMotivo" class="form-control" rows="3" 
                                      placeholder="Describa el motivo del estudio..." required></textarea>
                        </div>
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fas fa-edit"></i> Editar Orden de Estudio</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Tipo de Estudio: <span class="text-danger">*</span></label>
                            <select id="selectTipoEstudioEditar" class="form-select" required>
                                <option value="">Seleccione un tipo</option>
                            </select>
                        </div>
        ...
        <script>
                            ...
                            function buscarMascotas() {
                                ...
                                fetch('OrdenEstudioServlet?action=buscarMascotas&texto=' + encodeURIComponent(texto))
                                        .then(r => r.text())
                            ...
                            function verOrdenes(idMascota) {
                                ...
                                fetch('OrdenEstudioServlet?action=listarOrdenes&idMascota=' + idMascota)
                                        .then(r => r.text())
                                        .then(html => {
                            ...
                            function abrirModalRegistrar() {
                                ...
                                fetch('OrdenEstudioServlet?action=obtenerConsultas&idMascota=' + idMascotaActual)
                                        .then(r => r.text())
                                        .then(html => {
                                ...
                                fetch('OrdenEstudioServlet?action=obtenerTipos')
                                        .then(r => r.text())
                                        .then(html => {
                                            document.getElementById('selectTipoEstudio').innerHTML = html;
                                        });
                            ...
                            function guardarOrden() {
                                ...
                                const idTipoEstudio = document.getElementById('selectTipoEstudio').value;
                                ...
                                if (!idTipoEstudio) {
                                    document.getElementById('mensajeRegistrar').innerHTML =
                                            '<div class="alert alert-warning">Debe seleccionar un tipo de estudio</div>';
                                    return;
                                }
                            ...
                            function abrirModalEditar(idOrden, tipoEstudio, motivo, observaciones) {
                                ...
                                fetch('OrdenEstudioServlet?action=obtenerTipos')
                                        .then(r => r.text())
                                        .then(html => {
                                            document.getElementById('selectTipoEstudioEditar').innerHTML = html;

                                            const options = document.querySelectorAll('#selectTipoEstudioEditar option');
                                            for (let opt of options) {
                                                if (opt.text === tipoEstudio) {
                                                    opt.selected = true;
                                                    break;
                                                }
                                            }
                            ...
                            function guardarEdicion() {
                                ...
                                const idTipoEstudio = document.getElementById('selectTipoEstudioEditar').value;
